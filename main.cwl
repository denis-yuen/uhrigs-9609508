...
- {class: DockerRequirement, dockerImageId: '', dockerPull: 'quay.io/smc-rna-challenge/uhrigs-9609508-smc-rna-challenge-5:1.0.0'}
id: https://cgc-api.sbgenomics.com/v2/apps/uhrigs/smc-rna-challenge-5/arriba-0-9-sensitive-all/4/raw/
inputs:
...
- description: path to gzip-compressed FastQ file containing second mates
  ...
  sbg:fileTypes: FQ.GZ,FASTQ.GZ
  type: [File]
label: arriba-0.9-sensitive-all
outputs:
...
- class: CreateFileRequirement
  ...
  - {fileContent: "#!/bin/bash\n\nset -o pipefail\n\nif [ $# -ne 8 ]; then\n\techo\
      ...
      \t!(/^#/) &&\n\t$15 != \"low\" &&\n\t(homolog1 != homolog2 || $1 == $2) &&\n\
      \t!($1 ~ /^HIST[0-9]/ && $2 ~ /^HIST[0-9]/) &&\n\t!($1 ~ /^COL[0-9]/ && $2 ~\
      \ /^COL[0-9]/) &&\n\t!($1 ~ /^NBPF[0-9]/ && $2 ~ /^NBPF[0-9]/) &&\n\t!($1 ~\
      \ /^AC[0-9]+\\.[0-9]+$/ && $2 ~ /^AC[0-9]+\\.[0-9]+$/) &&\n\t!($1 ~ /PDE4DIP|MALAT1/\
      \ || $2 ~/PDE4DIP|MALAT1/) &&\n\t!($3 == \"./.\" || $4 == \"./.\")\n' \"$FUSIONS_OUT.tsv\"\
...
sbg:createdOn: 1494578890
sbg:id: uhrigs/smc-rna-challenge-5/arriba-0-9-sensitive-all/4
sbg:image_url: null
sbg:job:
...
sbg:modifiedOn: 1494584404
sbg:project: uhrigs/smc-rna-challenge-5
sbg:projectName: smc-rna-challenge-5
sbg:revision: 4
sbg:revisionsInfo:
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1494578890, 'sbg:revision': 0, 'sbg:revisionNotes': Copy
    of uhrigs/smc-rna-challenge-5/arriba-0-9-sensitive-pc-nocgc/2}
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1494579303, 'sbg:revision': 1, 'sbg:revisionNotes': null}
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1494581734, 'sbg:revision': 2, 'sbg:revisionNotes': null}
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1494582129, 'sbg:revision': 3, 'sbg:revisionNotes': null}
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1494584404, 'sbg:revision': 4, 'sbg:revisionNotes': null}
